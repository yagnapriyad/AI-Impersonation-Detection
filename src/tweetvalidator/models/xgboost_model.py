...
# -*- coding: utf-8 -*-
"""
Provides XgBoostModel which can be trained on tweet embeddings.
...
class XgBoostModel(Model):
    """ Trains a xg boost model to the embedded tweets provided.
    """
    ...
    def characterize(self, corpus, context_corpus):
        ...
        self.clf = xgb.XGBClassifier(n_estimators=10,
